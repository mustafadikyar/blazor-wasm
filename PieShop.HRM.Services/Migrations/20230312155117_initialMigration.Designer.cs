...
namespace PieShop.HRM.Services.Migrations
{
    ...
    [Migration("20230312155117_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieShop.HRM.Models.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("PieShop.HRM.Models.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("PieShop.HRM.Models.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PieShop.HRM.Models.Domain.Employee", b =>
                {
                    b.HasOne("PieShop.HRM.Models.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieShop.HRM.Models.Domain.JobCategory", "JobCategory")
                        .WithMany()
